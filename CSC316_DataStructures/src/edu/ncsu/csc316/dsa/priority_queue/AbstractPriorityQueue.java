...
public abstract class AbstractPriorityQueue<K extends Comparable<K>, V> implements PriorityQueue<K, V> {
	/** Comparator used to determine order of entries */
    ...
    public class NaturalOrder implements Comparator<K> {
    	...
    	/**
    	 * Method to return an int reflection the comparison of the two given values. Returns 1 if the first 
    	 * value comes before the second, -1 if the second value comes first, and 0 if the two values are 
    	 * the same.
    	 * 
    	 * @param first first value to compare
    	 * @param second second value to compare
    	 * @return an int reflecting the comparison of the two items
    	 */
    ...
    public static class PQEntry<K, V> implements Entry<K, V> {
    	/** Key used to determine PQEntry priority */
        private K key;
        /** Value held by the PQEntry */
        private V value;
