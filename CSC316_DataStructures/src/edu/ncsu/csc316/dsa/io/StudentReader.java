...
public class StudentReader {
	...
	private static Student processLine(String line) {
		...
		String unityId = splitLine[2];
		int id = Integer.valueOf(splitLine[3]);
		double gpa = Double.valueOf(splitLine[4]);
		int creditHours = Integer.valueOf(splitLine[5]);
		
		Student student = new Student(first, last, id, creditHours, gpa, unityId);
		return student;
	}
}
