...
/**
 * Test method for SelectionSorter
 * 
 * @author Kal Corwin
 */
public class SelectionSorterTest {
	...
	SelectionSorter<String> stringSort;
	/** SelectionSorter to use in Student tests */
	SelectionSorter<Student> studentSort;
	/** SelectionSorter to use in Student tests with GPA comparator */
	SelectionSorter<Student> studentGpaSort;
	...
	@Before
	public void setUp() {
		stringSort = new SelectionSorter<String>();
		studentSort = new SelectionSorter<Student>();
		studentGpaSort = new SelectionSorter<Student>(new StudentGPAComparator());
	}
	...
	public void testSortStudentsGpa() {
		...
		assertTrue(s2.equals(studentGpaDescending[0]));
