...
public class QuickSorterTest {
	...
	QuickSorter<String> stringSort;
	/** SelectionSorter to use in String tests */
	QuickSorter<String> stringSort2;
	/** SelectionSorter to use in Student tests */
	QuickSorter<Student> studentSort;
	...
	@Before
	public void setUp() {
		stringSort = new QuickSorter<String>();
		stringSort2 = new QuickSorter<String>(QuickSorter.FIRST_ELEMENT_SELECTOR);
		studentSort = new QuickSorter<Student>(QuickSorter.LAST_ELEMENT_SELECTOR);
		studentGpaSort = new QuickSorter<Student>(new StudentGPAComparator(), QuickSorter.MIDDLE_ELEMENT_SELECTOR);
	}
