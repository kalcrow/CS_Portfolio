 ...
 * Skeleton of this code copied from CSC316 Workshop 9 guide
 *
 * @author Dr. King
 *
 */
public class HeapAdaptablePriorityQueueTest {
	/** Heap to use for testing */
    ...
    public void testReplaceKey() {
        ...
        //Entry<Integer, String> e7 = 
        heap.insert(7, "seven");
        //Entry<Integer, String> e6 = 
        heap.insert(6, "six");
        //Entry<Integer, String> e5 = 
        heap.insert(5, "five");
        //Entry<Integer, String> e4 = 
        heap.insert(4, "four");
       // Entry<Integer, String> e3 = 
        heap.insert(3, "three");
        //Entry<Integer, String> e2 = 
        heap.insert(2, "two");
        //Entry<Integer, String> e1 = 
        heap.insert(1, "one");
        //Entry<Integer, String> e0 = 
        heap.insert(0, "zero");
